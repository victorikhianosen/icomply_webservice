                ...
                <table>
                    <tr>
                        <td colspan="2" style="border-right: none;font-weight: normal;">
                            <div>
                                <p style="word-wrap: break-word;"><i>The exception below was raised on a transaction you
                                        processed or an activity within your scope of responsibility.</i></p>
                                <p style="word-wrap: break-word;"><i>Please respond to the exception immediately,
                                        explaining the reason(s) behind it as well as what you are doing to prevent
                                        re-occurrence.</i> </p>
                                <p style="word-wrap: break-word;"><i>Note: The exception will remain open and therefore
                                        count against you unless resolved.</i> </p>
                            </div>
                        </td>
                    </tr>
                    <div>
                    ...
                    <tr>
                        ...
                        <td class="employee-response"><a href="https://www.google.com.mx/">click here to respond</a>
                        </td>
                    </tr>
                    <tr>
