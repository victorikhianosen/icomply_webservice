...
//         $sql = "select  
//                     a.account_number,
//                     a.prodccy AS product_ccy,
//                     a.prodcat AS product_category,
//                     a.teller_id,
//                 CASE
//                 WHEN a.working_balance = '' THEN '0'
//                 ELSE TO_CHAR(a.working_balance::numeric, '9,999,999,999,999.99')
//                 END AS working_balance,
//                     a.grp_ccy,
//                     a.grp_ac_no,
//                     a.category,
//                     a.customer,
...
//                     a.position_type,
//                     a.currency,
//                     TO_CHAR(TO_DATE(a.opening_date, 'YYYYMMDD'), 'DD-MON-YYYY') as opening_date,
//                     a.currency_market,
//                     a.account_officer,
//                     a.other_officer,
//                     a.posting_restrict,
//                     f.description as posting_restrict_description,
//                     f.restriction_type,
//                     a.open_actual_bal,
//                     a.open_cleared_bal,
//                     a.online_actual_bal,
//                     a.online_cleared_bal,
//                     a.date_last_cr_cust,
//                     a.amnt_last_cr_cust,
//                     a.tran_last_cr_cust,
//                     a.date_last_cr_bank,
...
//                     a.alt_acct_type,
//                     a.alt_acct_id,
//                     a.open_available_bal,
//                     TO_CHAR(TO_DATE(a.date_last_update, 'YYYYMMDD'), 'DD-MON-YYYY') as date_last_update,
//                     a.curr_no,
//                     a.inputter,
//                     a.date_time,
//                     a.authoriser,
...
//                     b.description,
//                     b.short_name
//            from v_fsbn_account a
//             LEFT OUTER JOIN V_F_CATEGORY b
//             ON a.CATEGORY = b.CATEGORY_CODE
//             LEFT OUTER JOIN v_fsbn_aa_arrangement c
//             ON a.ARRANGEMENT_ID = c.ARRANGEMENT_ID
//             LEFT OUTER JOIN v_f_company e
//             ON a.CO_CODE = e.COMPANY_CODE
//             LEFT OUTER JOIN v_f_posting_restrict f
//             ON a.posting_restrict = f.posting_restr_code
// WHERE CAST(a.category AS TEXT) LIKE '1%' OR CAST(a.category AS TEXT) LIKE '6%'";
//         $exceptios =  Process::find(28);
//         $exceptios->update([
//             'sql_text' => $sql,
//             'type_id'=>222
//         ]);
